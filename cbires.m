% References:
% Ali Ghaznavi 
%"Combining global, regional and contextual features for AIA System".
% Copyright (c) 2014,  
...
% Last Modified by GUIDE v2.5 23-May-2014 22:01:15
...
%         guidata(hObject, handles);
        ...
        guidata(hObject, handles);
        helpdlg('Proceed with the query by executing the Image annotation button!');
